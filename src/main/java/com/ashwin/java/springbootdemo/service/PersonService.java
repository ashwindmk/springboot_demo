package com.ashwin.java.springbootdemo.service;

import com.ashwin.java.springbootdemo.dao.PersonDao;
...
public class PersonService {
    ...
    @Autowired
    public PersonService(@Qualifier("fake-person-dao") PersonDao personDao) {
